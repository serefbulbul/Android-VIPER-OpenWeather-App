...
public class HomePageModule {
    ...
    @HomePageScope
    @Provides
    public HomePageContract.Interactor interactor(OpenWeatherService openWeatherService, RealmService realmService) {
        return new HomePageInteractor(openWeatherService, realmService);
    }
}
